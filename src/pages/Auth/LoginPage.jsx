...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    return (
      <div  className=" bg-[url('/src/assets/about/auth/register.svg')] absolute  bg-main bg-cover и bg-center lg:bg-white lg:bg-none   top-0 right-0 left-0 bottom-0  flex flex-col items-center justify-center ">
        ...
        <div className="container flex items-center justify-center mx-auto ">
          <div className="z-10 flex items-center md:h-auto lg:static md:w-1/2">
            <div className=" 2xl:pt-[60px]  relative px-4   md:px-0   py-12 md:ps-[0px] xl:ps-[40px] flex flex-col justify-center   2xl:ps-[70px]">
              ...
              <div className=" lg:pt-12 lg:border-none border border-white rounded-md login p-[10px] xl:ps-[70px] mt-[23px] lg:mt-103px]">
                <h1 className=" text-[20px] md:text-[30px] text-white lg:text-main font-bold text-center">
                ...
                <div className="relative  mt-[20px] text-[12px]      ">
                  ...
                  >
                    <div className="flex flex-col items-start justify-start w-full">
                      <label
                        htmlFor="email"
                        className="cursor-pointer text-white  lg:text-black   text-[13px] md:text-[16px] "
                      >
                    ...
                    <div className="flex flex-col items-start justify-start w-full">
                      ...
                      <div className="focus-within:shadow-shadowInput  transition-all w-full flex mt-1 items-center rounded-[4px] px-[15px] bg-white border-dashed border border-main   ">
                        <label
                          htmlFor="password"
                          className="text-white mr-[15px] cursor-pointer  lg:text-black "
                        >
                          <svg
                            width="20"
                            height="20"
                    ...
                    <DefaultBtn
                      classNameList="px-[40px] bg-white  md:bg-main lg:text-white"
                      loading={loading}
                      more={{ type: "submit" }}
                  ...
                  <div
                    to="/login"
                    className={
                      "text-center flex gap-2 justify-center text-[#1A1A40] lg:text-black  font-proppins  text-[14px] md:text-[18px] mt-[20px] w-full"
                    }
                  >
                    <span >{t(`main.forms.labels.loginQuestion`)}</span>
                    <NavLink to={"/register"} className="text-white lg:text-main">
          ...
          <div className="  hidden lg:flex   items-center justify-center w-full lg:h-auto lg:static lg:w-1/2 bg-main">
            <img
              src={BgImg2}
              alt=""
              className="  object-cover max-h-[570px] "
            />
          </div>
        </div>
      </div>
